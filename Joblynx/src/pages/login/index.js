      ...
      <RightWrapper sx={skin === 'bordered' && !hidden ? { borderLeft: `1px solid ${theme.palette.divider}` } : {}}>
        ...
        >
          <BoxWrapper>
            ...
            >
              <svg width={60} fill='none' height={80} viewBox='5 45 150 100' xmlns='http://www.w3.org/2000/svg'>
              <g>
              ...
              <Typography variant='h6' sx={{ ml: 3, lineHeight: 1, fontWeight: 800, fontSize: '1.5rem !important'}}>
                {themeConfig.templateName}
              </Typography>
            </Box>
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5' sx={{textAlign:'center'}}>{`Welcome to ${themeConfig.templateName}! 👋🏻`}</TypographyStyled>
